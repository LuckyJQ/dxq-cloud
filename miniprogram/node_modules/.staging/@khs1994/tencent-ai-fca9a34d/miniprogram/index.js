...
var node_fetch = _interopDefault(require('wx-fetch'));
...
function request(url) {
    return __awaiter(this, void 0, void 0, function* () {
        const file = temp();
        undefined(file, yield node_fetch(url).then(res => {
            return res.buffer();
        }));
        return file;
    });
...
function readFileDenoHandler (item, limit = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // @ts-ignore
        let base64Handler = yield new Promise(function (resolve) { resolve(_interopNamespace(require('https://deno.land/x/base64/mod.ts'))); });
        // @ts-ignore
