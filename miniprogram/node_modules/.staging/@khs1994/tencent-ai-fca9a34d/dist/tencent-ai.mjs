...
import { mkdirSync, accessSync, writeFileSync, readFileSync as readFileSync$1, unlink } from 'fs';
...
function request(url) {
    return __awaiter(this, void 0, void 0, function* () {
        const file = temp();
        writeFileSync(file, yield node_fetch(url).then(res => {
            return res.buffer();
        }));
        return file;
    });
