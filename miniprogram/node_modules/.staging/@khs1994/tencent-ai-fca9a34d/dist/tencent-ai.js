...
(function (global, factory) {
    ...
    (global = global || self, factory(global.TencentAI = {}));
    ...
    ***************************************************************************** */
    ...
    function temp () {
        let random = Date.now() * Math.round(Math.random() * 10);
        let dir = `/tmp/tencent_ai`;
        try {
            undefined(dir);
        }
        catch (e) {
    ...
    function readFileNodeHandler(item, limit = 0) {
    ...
    function request(url) {
        return __awaiter(this, void 0, void 0, function* () {
            const file = temp();
            undefined(file, yield browser(url).then(res => {
                return res.buffer();
            }));
            return file;
        });
    ...
    function readFileDenoHandler (item, limit = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            let isFile = false;
            let isUrl = false;
            let file;
            ...
            try {
                // @ts-ignore
                let fileInfo = yield Deno.stat(item);
            ...
            // @ts-ignore
            let base64Handler = yield import('https://deno.land/x/base64/mod.ts');
            // @ts-ignore
            base64 = base64Handler.fromUint8Array(yield Deno.readFile(file));
            if (isUrl) {
                // @ts-ignore
    ...
    var version="19.6.0-alpha.6";

    class AbstractTencentAI {
        constructor(appKey, appId, proxy = 'https://api.ai.qq.com') {
            this.appKey = appKey;
            this.appId = appId;
            this.proxy = proxy;
            this.isWx = false;
            ...
            this.supportFetch = false;
            this.version = `v${version.trim('v')}`;
            if (!appKey || !appId) {
        ...
        readFileSync(file, limit = 0) {
            return __awaiter(this, void 0, void 0, function* () {
                if (this.isWx) {
                    return yield readFileSync(file);
                }
                if (this.isNode) {
                    return yield readFileNodeHandler(file, limit);
                }
                if (this.isDeno) {
                    return yield readFileDenoHandler(file, limit);
                }
                return file;
            });
        }
    ...
    function str2rstr_utf8(c) { var b = ""; var d = -1; var a, e; while (++d < c.length) {
        a = c.charCodeAt(d);
    ...
    function rstr2binl(b) { var a = Array(b.length >> 2); for (var c = 0; c < a.length; c++) {
        a[c] = 0;
    } for (var c = 0; c < b.length * 8; c += 8) {
        a[c >> 5] |= (b.charCodeAt(c / 8) & 255) << (c % 32);
    } return a; }
    function binl2rstr(b) { var a = ""; for (var c = 0; c < b.length * 32; c += 8) {
        a += String.fromCharCode((b[c >> 5] >>> (c % 32)) & 255);
    } return a; }
    function binl_md5(p, k) { p[k >> 5] |= 128 << ((k) % 32); p[(((k + 64) >>> 9) << 4) + 14] = k; var o = 1732584193; var n = -271733879; var m = -1732584194; var l = 271733878; for (var g = 0; g < p.length; g += 16) {
        var j = o;
        var h = n;
        var f = m;
        var e = l;
    ...
    function urlencodeByTextEncoder(text) {
    ...
    function urlencodeReplace(array) {
        let strList = '';
        array.map((item) => {
            switch (true) {
                // ascii 0
    ...
    var errorCode;
    (function (errorCode) {
        errorCode[errorCode["\u53C2\u6570\u975E\u6CD5---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u53C2\u6570\u662F\u5426\u7B26\u5408\u8981\u6C42"] = 4096] = "\u53C2\u6570\u975E\u6CD5---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u53C2\u6570\u662F\u5426\u7B26\u5408\u8981\u6C42";
        errorCode[errorCode["\u5E94\u7528\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5app_id\u662F\u5426\u6709\u6548\u7684\u5E94\u7528\u6807\u8BC6\uFF08AppId\uFF09"] = 12289] = "\u5E94\u7528\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5app_id\u662F\u5426\u6709\u6548\u7684\u5E94\u7528\u6807\u8BC6\uFF08AppId\uFF09";
        errorCode[errorCode["\u7D20\u6750\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5app_id\u5BF9\u5E94\u7684\u7D20\u6750\u6A21\u7248id"] = 12801] = "\u7D20\u6750\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5app_id\u5BF9\u5E94\u7684\u7D20\u6750\u6A21\u7248id";
        errorCode[errorCode["\u7D20\u6750ID\u4E0E\u5E94\u7528ID\u4E0D\u5339\u914D---\u8BF7\u68C0\u67E5app_id\u5BF9\u5E94\u7684\u7D20\u6750\u6A21\u7248id"] = 12802] = "\u7D20\u6750ID\u4E0E\u5E94\u7528ID\u4E0D\u5339\u914D---\u8BF7\u68C0\u67E5app_id\u5BF9\u5E94\u7684\u7D20\u6750\u6A21\u7248id";
        errorCode[errorCode["\u7F3A\u5C11app_id\u53C2\u6570---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u4E2D\u662F\u5426\u5305\u542B\u6709\u6548\u7684app_id\u53C2\u6570"] = 16385] = "\u7F3A\u5C11app_id\u53C2\u6570---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u4E2D\u662F\u5426\u5305\u542B\u6709\u6548\u7684app_id\u53C2\u6570";
        errorCode[errorCode["\u7F3A\u5C11time_stamp\u53C2\u6570---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u4E2D\u662F\u5426\u5305\u542B\u6709\u6548\u7684time_stamp\u53C2\u6570"] = 16386] = "\u7F3A\u5C11time_stamp\u53C2\u6570---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u4E2D\u662F\u5426\u5305\u542B\u6709\u6548\u7684time_stamp\u53C2\u6570";
        errorCode[errorCode["\u7F3A\u5C11nonce_str\u53C2\u6570---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u4E2D\u662F\u5426\u5305\u542B\u6709\u6548\u7684nonce_str\u53C2\u6570"] = 16387] = "\u7F3A\u5C11nonce_str\u53C2\u6570---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u4E2D\u662F\u5426\u5305\u542B\u6709\u6548\u7684nonce_str\u53C2\u6570";
        errorCode[errorCode["\u8BF7\u6C42\u7B7E\u540D\u65E0\u6548---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u4E2D\u7684\u7B7E\u540D\u4FE1\u606F\uFF08sign\uFF09\u662F\u5426\u6709\u6548"] = 16388] = "\u8BF7\u6C42\u7B7E\u540D\u65E0\u6548---\u8BF7\u68C0\u67E5\u8BF7\u6C42\u4E2D\u7684\u7B7E\u540D\u4FE1\u606F\uFF08sign\uFF09\u662F\u5426\u6709\u6548";
        errorCode[errorCode["\u7F3A\u5931API\u6743\u9650---\u8BF7\u68C0\u67E5\u5E94\u7528\u662F\u5426\u52FE\u9009\u5F53\u524DAPI\u6240\u5C5E\u63A5\u53E3\u7684\u6743\u9650"] = 16389] = "\u7F3A\u5931API\u6743\u9650---\u8BF7\u68C0\u67E5\u5E94\u7528\u662F\u5426\u52FE\u9009\u5F53\u524DAPI\u6240\u5C5E\u63A5\u53E3\u7684\u6743\u9650";
        errorCode[errorCode["time_stamp\u53C2\u6570\u65E0\u6548---\u8BF7\u68C0\u67E5time_stamp\u8DDD\u79BB\u5F53\u524D\u65F6\u95F4\u662F\u5426\u8D85\u8FC75\u5206\u949F"] = 16390] = "time_stamp\u53C2\u6570\u65E0\u6548---\u8BF7\u68C0\u67E5time_stamp\u8DDD\u79BB\u5F53\u524D\u65F6\u95F4\u662F\u5426\u8D85\u8FC75\u5206\u949F";
        errorCode[errorCode["\u540C\u4E49\u8BCD\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A---\u7CFB\u7EDF\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A"] = 16391] = "\u540C\u4E49\u8BCD\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A---\u7CFB\u7EDF\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A";
        errorCode[errorCode["\u4E13\u6709\u540D\u8BCD\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A---\u7CFB\u7EDF\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A"] = 16392] = "\u4E13\u6709\u540D\u8BCD\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A---\u7CFB\u7EDF\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A";
        errorCode[errorCode["\u610F\u56FE\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A---\u7CFB\u7EDF\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A"] = 16393] = "\u610F\u56FE\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A---\u7CFB\u7EDF\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A";
        errorCode[errorCode["\u95F2\u804A\u8FD4\u56DE\u7ED3\u679C\u4E3A\u7A7A---\u7CFB\u7EDF\u5904\u7406\u7ED3\u679C\u4E3A\u7A7A"] = 16394] = "\u95F2\u804A\u8FD4\u56DE\u7ED3\u679C\u4E3A\u7A7A---\u7CFB\u7EDF\u5904\u7406\u7ED3\u679C\u4E3A\u7A7A";
        errorCode[errorCode["\u56FE\u7247\u683C\u5F0F\u975E\u6CD5---\u8BF7\u68C0\u67E5\u56FE\u7247\u683C\u5F0F\u662F\u5426\u7B26\u5408API\u8981\u6C42"] = 16396] = "\u56FE\u7247\u683C\u5F0F\u975E\u6CD5---\u8BF7\u68C0\u67E5\u56FE\u7247\u683C\u5F0F\u662F\u5426\u7B26\u5408API\u8981\u6C42";
        errorCode[errorCode["\u56FE\u7247\u4F53\u79EF\u8FC7\u5927---\u8BF7\u68C0\u67E5\u56FE\u7247\u5927\u5C0F\u662F\u5426\u8D85\u8FC7API\u9650\u5236"] = 16397] = "\u56FE\u7247\u4F53\u79EF\u8FC7\u5927---\u8BF7\u68C0\u67E5\u56FE\u7247\u5927\u5C0F\u662F\u5426\u8D85\u8FC7API\u9650\u5236";
        errorCode[errorCode["\u56FE\u7247\u6CA1\u6709\u4EBA\u8138---\u8BF7\u68C0\u67E5\u56FE\u7247\u662F\u5426\u5305\u542B\u4EBA\u8138"] = 16402] = "\u56FE\u7247\u6CA1\u6709\u4EBA\u8138---\u8BF7\u68C0\u67E5\u56FE\u7247\u662F\u5426\u5305\u542B\u4EBA\u8138";
        errorCode[errorCode["\u76F8\u4F3C\u5EA6\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16403] = "\u76F8\u4F3C\u5EA6\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u4EBA\u8138\u68C0\u6D4B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16404] = "\u4EBA\u8138\u68C0\u6D4B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u56FE\u7247\u89E3\u7801\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16405] = "\u56FE\u7247\u89E3\u7801\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u7279\u5F81\u5904\u7406\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16406] = "\u7279\u5F81\u5904\u7406\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u63D0\u53D6\u8F6E\u5ED3\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16407] = "\u63D0\u53D6\u8F6E\u5ED3\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u63D0\u53D6\u6027\u522B\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16408] = "\u63D0\u53D6\u6027\u522B\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u63D0\u53D6\u8868\u60C5\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16409] = "\u63D0\u53D6\u8868\u60C5\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u63D0\u53D6\u5E74\u9F84\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16410] = "\u63D0\u53D6\u5E74\u9F84\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u63D0\u53D6\u59FF\u6001\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16411] = "\u63D0\u53D6\u59FF\u6001\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u63D0\u53D6\u773C\u955C\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16412] = "\u63D0\u53D6\u773C\u955C\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u63D0\u53D6\u9B45\u529B\u503C\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16413] = "\u63D0\u53D6\u9B45\u529B\u503C\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u8BED\u97F3\u5408\u6210\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16414] = "\u8BED\u97F3\u5408\u6210\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u56FE\u7247\u4E3A\u7A7A---\u8BF7\u68C0\u67E5\u56FE\u7247\u662F\u5426\u6B63\u5E38"] = 16415] = "\u56FE\u7247\u4E3A\u7A7A---\u8BF7\u68C0\u67E5\u56FE\u7247\u662F\u5426\u6B63\u5E38";
        errorCode[errorCode["\u4E2A\u4F53\u5DF2\u5B58\u5728---\u8BF7\u68C0\u67E5\u4E2A\u4F53\u662F\u5426\u5DF2\u5B58\u5728"] = 16416] = "\u4E2A\u4F53\u5DF2\u5B58\u5728---\u8BF7\u68C0\u67E5\u4E2A\u4F53\u662F\u5426\u5DF2\u5B58\u5728";
        errorCode[errorCode["\u4E2A\u4F53\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5\u4E2A\u4F53\u662F\u5426\u4E0D\u5B58\u5728"] = 16417] = "\u4E2A\u4F53\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5\u4E2A\u4F53\u662F\u5426\u4E0D\u5B58\u5728";
        errorCode[errorCode["\u4EBA\u8138\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5\u4EBA\u8138\u662F\u5426\u4E0D\u5B58\u5728"] = 16418] = "\u4EBA\u8138\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5\u4EBA\u8138\u662F\u5426\u4E0D\u5B58\u5728";
        errorCode[errorCode["\u5206\u7EC4\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5\u5206\u7EC4\u662F\u5426\u4E0D\u5B58\u5728"] = 16419] = "\u5206\u7EC4\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5\u5206\u7EC4\u662F\u5426\u4E0D\u5B58\u5728";
        errorCode[errorCode["\u5206\u7EC4\u5217\u8868\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5\u5206\u7EC4\u5217\u8868\u662F\u5426\u4E0D\u5B58\u5728"] = 16420] = "\u5206\u7EC4\u5217\u8868\u4E0D\u5B58\u5728---\u8BF7\u68C0\u67E5\u5206\u7EC4\u5217\u8868\u662F\u5426\u4E0D\u5B58\u5728";
        errorCode[errorCode["\u4EBA\u8138\u4E2A\u6570\u8D85\u8FC7\u9650\u5236---\u8BF7\u68C0\u67E5\u662F\u5426\u8D85\u8FC7\u7CFB\u7EDF\u9650\u5236"] = 16421] = "\u4EBA\u8138\u4E2A\u6570\u8D85\u8FC7\u9650\u5236---\u8BF7\u68C0\u67E5\u662F\u5426\u8D85\u8FC7\u7CFB\u7EDF\u9650\u5236";
        errorCode[errorCode["\u4E2A\u4F53\u4E2A\u6570\u8D85\u8FC7\u9650\u5236---\u8BF7\u68C0\u67E5\u662F\u5426\u8D85\u8FC7\u7CFB\u7EDF\u9650\u5236"] = 16422] = "\u4E2A\u4F53\u4E2A\u6570\u8D85\u8FC7\u9650\u5236---\u8BF7\u68C0\u67E5\u662F\u5426\u8D85\u8FC7\u7CFB\u7EDF\u9650\u5236";
        errorCode[errorCode["\u7EC4\u4E2A\u6570\u8D85\u8FC7\u9650\u5236---\u8BF7\u68C0\u67E5\u662F\u5426\u8D85\u8FC7\u7CFB\u7EDF\u9650\u5236"] = 16423] = "\u7EC4\u4E2A\u6570\u8D85\u8FC7\u9650\u5236---\u8BF7\u68C0\u67E5\u662F\u5426\u8D85\u8FC7\u7CFB\u7EDF\u9650\u5236";
        errorCode[errorCode["\u5BF9\u4E2A\u4F53\u6DFB\u52A0\u4E86\u51E0\u4E4E\u76F8\u540C\u7684\u4EBA\u8138---\u8BF7\u68C0\u67E5\u4E2A\u4F53\u5DF2\u6DFB\u52A0\u7684\u4EBA\u8138"] = 16424] = "\u5BF9\u4E2A\u4F53\u6DFB\u52A0\u4E86\u51E0\u4E4E\u76F8\u540C\u7684\u4EBA\u8138---\u8BF7\u68C0\u67E5\u4E2A\u4F53\u5DF2\u6DFB\u52A0\u7684\u4EBA\u8138";
        errorCode[errorCode["\u65E0\u6548\u7684\u56FE\u7247\u683C\u5F0F---\u8BF7\u68C0\u67E5\u56FE\u7247\u683C\u5F0F\u662F\u5426\u7B26\u53F7API\u8981\u6C42"] = 16425] = "\u65E0\u6548\u7684\u56FE\u7247\u683C\u5F0F---\u8BF7\u68C0\u67E5\u56FE\u7247\u683C\u5F0F\u662F\u5426\u7B26\u53F7API\u8981\u6C42";
        errorCode[errorCode["\u56FE\u7247\u6A21\u7CCA\u5EA6\u68C0\u6D4B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16426] = "\u56FE\u7247\u6A21\u7CCA\u5EA6\u68C0\u6D4B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u7F8E\u98DF\u56FE\u7247\u68C0\u6D4B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16427] = "\u7F8E\u98DF\u56FE\u7247\u68C0\u6D4B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u63D0\u53D6\u56FE\u50CF\u6307\u7EB9\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16428] = "\u63D0\u53D6\u56FE\u50CF\u6307\u7EB9\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u56FE\u50CF\u7279\u5F81\u6BD4\u5BF9\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16429] = "\u56FE\u50CF\u7279\u5F81\u6BD4\u5BF9\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["OCR\u7167\u7247\u4E3A\u7A7A---\u8BF7\u68C0\u67E5\u5F85\u5904\u7406\u56FE\u7247\u662F\u5426\u4E3A\u7A7A"] = 16430] = "OCR\u7167\u7247\u4E3A\u7A7A---\u8BF7\u68C0\u67E5\u5F85\u5904\u7406\u56FE\u7247\u662F\u5426\u4E3A\u7A7A";
        errorCode[errorCode["OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16431] = "OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u8F93\u5165\u56FE\u7247\u4E0D\u662F\u8EAB\u4EFD\u8BC1---\u8BF7\u68C0\u67E5\u56FE\u7247\u662F\u5426\u4E3A\u8EAB\u4EFD\u8BC1"] = 16432] = "\u8F93\u5165\u56FE\u7247\u4E0D\u662F\u8EAB\u4EFD\u8BC1---\u8BF7\u68C0\u67E5\u56FE\u7247\u662F\u5426\u4E3A\u8EAB\u4EFD\u8BC1";
        errorCode[errorCode["\u540D\u7247\u65E0\u8DB3\u591F\u6587\u672C---\u8BF7\u68C0\u67E5\u540D\u7247\u662F\u5426\u6B63\u5E38"] = 16433] = "\u540D\u7247\u65E0\u8DB3\u591F\u6587\u672C---\u8BF7\u68C0\u67E5\u540D\u7247\u662F\u5426\u6B63\u5E38";
        errorCode[errorCode["\u540D\u7247\u6587\u672C\u884C\u503E\u659C\u89D2\u5EA6\u592A\u5927---\u8BF7\u68C0\u67E5\u540D\u7247\u662F\u5426\u6B63\u5E38"] = 16434] = "\u540D\u7247\u6587\u672C\u884C\u503E\u659C\u89D2\u5EA6\u592A\u5927---\u8BF7\u68C0\u67E5\u540D\u7247\u662F\u5426\u6B63\u5E38";
        errorCode[errorCode["\u540D\u7247\u6A21\u7CCA---\u8BF7\u68C0\u67E5\u540D\u7247\u662F\u5426\u6B63\u5E38"] = 16435] = "\u540D\u7247\u6A21\u7CCA---\u8BF7\u68C0\u67E5\u540D\u7247\u662F\u5426\u6B63\u5E38";
        errorCode[errorCode["\u540D\u7247\u59D3\u540D\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16436] = "\u540D\u7247\u59D3\u540D\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u540D\u7247\u7535\u8BDD\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16437] = "\u540D\u7247\u7535\u8BDD\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u56FE\u50CF\u4E3A\u975E\u540D\u7247\u56FE\u50CF---\u8BF7\u68C0\u67E5\u56FE\u7247\u662F\u5426\u4E3A\u540D\u7247"] = 16438] = "\u56FE\u50CF\u4E3A\u975E\u540D\u7247\u56FE\u50CF---\u8BF7\u68C0\u67E5\u56FE\u7247\u662F\u5426\u4E3A\u540D\u7247";
        errorCode[errorCode["\u68C0\u6D4B\u6216\u8005\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16439] = "\u68C0\u6D4B\u6216\u8005\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u672A\u68C0\u6D4B\u5230\u8EAB\u4EFD\u8BC1---\u8BF7\u5BF9\u51C6\u8FB9\u6846(\u907F\u514D\u62CD\u6444\u65F6\u503E\u89D2\u548C\u65CB\u8F6C\u89D2\u8FC7\u5927\u3001\u6444\u50CF\u5934)"] = 16440] = "\u672A\u68C0\u6D4B\u5230\u8EAB\u4EFD\u8BC1---\u8BF7\u5BF9\u51C6\u8FB9\u6846(\u907F\u514D\u62CD\u6444\u65F6\u503E\u89D2\u548C\u65CB\u8F6C\u89D2\u8FC7\u5927\u3001\u6444\u50CF\u5934)";
        errorCode[errorCode["\u8BF7\u4F7F\u7528\u7B2C\u4E8C\u4EE3\u8EAB\u4EFD\u8BC1\u4EF6\u8FDB\u884C\u626B\u63CF---\u8BF7\u4F7F\u7528\u7B2C\u4E8C\u4EE3\u8EAB\u4EFD\u8BC1\u8FDB\u884C\u5904\u7406"] = 16441] = "\u8BF7\u4F7F\u7528\u7B2C\u4E8C\u4EE3\u8EAB\u4EFD\u8BC1\u4EF6\u8FDB\u884C\u626B\u63CF---\u8BF7\u4F7F\u7528\u7B2C\u4E8C\u4EE3\u8EAB\u4EFD\u8BC1\u8FDB\u884C\u5904\u7406";
        errorCode[errorCode["\u4E0D\u662F\u8EAB\u4EFD\u8BC1\u6B63\u9762\u7167\u7247---\u8BF7\u4F7F\u7528\u5E26\u8BC1\u4EF6\u7167\u7684\u4E00\u9762\u8FDB\u884C\u5904\u7406"] = 16442] = "\u4E0D\u662F\u8EAB\u4EFD\u8BC1\u6B63\u9762\u7167\u7247---\u8BF7\u4F7F\u7528\u5E26\u8BC1\u4EF6\u7167\u7684\u4E00\u9762\u8FDB\u884C\u5904\u7406";
        errorCode[errorCode["\u4E0D\u662F\u8EAB\u4EFD\u8BC1\u53CD\u9762\u7167\u7247---\u8BF7\u4F7F\u7528\u8EAB\u4EFD\u8BC1\u53CD\u9762\u8FDB\u884C\u8FDB\u884C\u5904\u7406"] = 16443] = "\u4E0D\u662F\u8EAB\u4EFD\u8BC1\u53CD\u9762\u7167\u7247---\u8BF7\u4F7F\u7528\u8EAB\u4EFD\u8BC1\u53CD\u9762\u8FDB\u884C\u8FDB\u884C\u5904\u7406";
        errorCode[errorCode["\u8BC1\u4EF6\u56FE\u7247\u6A21\u7CCA---\u8BF7\u786E\u4FDD\u8BC1\u4EF6\u56FE\u7247\u6E05\u6670"] = 16444] = "\u8BC1\u4EF6\u56FE\u7247\u6A21\u7CCA---\u8BF7\u786E\u4FDD\u8BC1\u4EF6\u56FE\u7247\u6E05\u6670";
        errorCode[errorCode["\u8BF7\u907F\u5F00\u706F\u5149\u76F4\u5C04\u5728\u8BC1\u4EF6\u8868\u9762---\u8BF7\u907F\u5F00\u706F\u5149\u76F4\u5C04\u5728\u8BC1\u4EF6\u8868\u9762"] = 16445] = "\u8BF7\u907F\u5F00\u706F\u5149\u76F4\u5C04\u5728\u8BC1\u4EF6\u8868\u9762---\u8BF7\u907F\u5F00\u706F\u5149\u76F4\u5C04\u5728\u8BC1\u4EF6\u8868\u9762";
        errorCode[errorCode["\u884C\u9A7E\u9A76\u8BC1OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16446] = "\u884C\u9A7E\u9A76\u8BC1OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u901A\u7528OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16447] = "\u901A\u7528OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u94F6\u884C\u5361OCR\u9884\u5904\u7406\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16448] = "\u94F6\u884C\u5361OCR\u9884\u5904\u7406\u9519\u8BEF---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u94F6\u884C\u5361OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16449] = "\u94F6\u884C\u5361OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u8425\u4E1A\u6267\u7167OCR\u9884\u5904\u7406\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16450] = "\u8425\u4E1A\u6267\u7167OCR\u9884\u5904\u7406\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u8425\u4E1A\u6267\u7167OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16451] = "\u8425\u4E1A\u6267\u7167OCR\u8BC6\u522B\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u610F\u56FE\u8BC6\u522B\u8D85\u65F6---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16452] = "\u610F\u56FE\u8BC6\u522B\u8D85\u65F6---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u95F2\u804A\u5904\u7406\u8D85\u65F6---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16453] = "\u95F2\u804A\u5904\u7406\u8D85\u65F6---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u8BED\u97F3\u8BC6\u522B\u89E3\u7801\u5931\u8D25---\u8BF7\u68C0\u67E5\u8BED\u97F3\u53C2\u6570\u662F\u5426\u6B63\u786E\u7F16\u7801"] = 16454] = "\u8BED\u97F3\u8BC6\u522B\u89E3\u7801\u5931\u8D25---\u8BF7\u68C0\u67E5\u8BED\u97F3\u53C2\u6570\u662F\u5426\u6B63\u786E\u7F16\u7801";
        errorCode[errorCode["\u8BED\u97F3\u8FC7\u957F\u6216\u7A7A---\u8BF7\u68C0\u67E5\u8BED\u97F3\u53C2\u6570\u662F\u5426\u6B63\u786E\u7F16\u7801\u6216\u8005\u957F\u5EA6\u662F\u5426\u5408\u6CD5"] = 16455] = "\u8BED\u97F3\u8FC7\u957F\u6216\u7A7A---\u8BF7\u68C0\u67E5\u8BED\u97F3\u53C2\u6570\u662F\u5426\u6B63\u786E\u7F16\u7801\u6216\u8005\u957F\u5EA6\u662F\u5426\u5408\u6CD5";
        errorCode[errorCode["\u7FFB\u8BD1\u5F15\u64CE\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898"] = 16456] = "\u7FFB\u8BD1\u5F15\u64CE\u5931\u8D25---\u8BF7\u8054\u7CFB\u5BA2\u670D\u53CD\u9988\u95EE\u9898";
        errorCode[errorCode["\u4E0D\u652F\u6301\u7684\u7FFB\u8BD1\u7C7B\u578B---\u8BF7\u68C0\u67E5\u7FFB\u8BD1\u7C7B\u578B\u53C2\u6570\u662F\u5426\u5408\u6CD5"] = 16457] = "\u4E0D\u652F\u6301\u7684\u7FFB\u8BD1\u7C7B\u578B---\u8BF7\u68C0\u67E5\u7FFB\u8BD1\u7C7B\u578B\u53C2\u6570\u662F\u5426\u5408\u6CD5";
        errorCode[errorCode["\u8F93\u5165\u56FE\u7247\u4E0E\u8BC6\u522B\u573A\u666F\u4E0D\u5339\u914D---\u8BF7\u68C0\u67E5\u573A\u666F\u53C2\u6570\u662F\u5426\u6B63\u786E\uFF0C\u6240\u4F20\u56FE\u7247\u4E0E\u573A\u666F\u662F\u5426\u5339\u914D"] = 16460] = "\u8F93\u5165\u56FE\u7247\u4E0E\u8BC6\u522B\u573A\u666F\u4E0D\u5339\u914D---\u8BF7\u68C0\u67E5\u573A\u666F\u53C2\u6570\u662F\u5426\u6B63\u786E\uFF0C\u6240\u4F20\u56FE\u7247\u4E0E\u573A\u666F\u662F\u5426\u5339\u914D";
        errorCode[errorCode["\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A---\u5F53\u524D\u56FE\u7247\u65E0\u6CD5\u5339\u914D\u5DF2\u6536\u5F55\u7684\u6807\u7B7E\uFF0C\u8BF7\u5C1D\u8BD5\u66F4\u6362\u56FE\u7247"] = 16461] = "\u8BC6\u522B\u7ED3\u679C\u4E3A\u7A7A---\u5F53\u524D\u56FE\u7247\u65E0\u6CD5\u5339\u914D\u5DF2\u6536\u5F55\u7684\u6807\u7B7E\uFF0C\u8BF7\u5C1D\u8BD5\u66F4\u6362\u56FE\u7247";
    })(errorCode || (errorCode = {}));
    ...
    function handle_gbk(sort_list, isGbk = false) {
        let str = '';
        if (isGbk) {
            ...
            sort_list.map(item => {
                if (item.value !== '') {
                    ...
                    str += `${item.key}=${typeof TextEncoder === 'undefined'
    ...
    function signHandler (data, appKey, isGbk = false) {
        ...
        let str = handle_gbk(sort_list, isGbk);
        // 追加 app_key
        // MD5 运算
    ...
    var browser_1$1 = browser$1.Headers;
    var browser_2$1 = browser$1.Request;
    var browser_3$1 = browser$1.Response;

    function Request (proxy, url, appKey, data, isGbk = false, method = 'post') {
        return __awaiter(this, void 0, void 0, function* () {
            let fetchHandler;
            if (typeof fetch === 'function') {
                ...
                // @ts-ignore
                fetchHandler = browser;
            }
            else if (typeof wx === 'object') {
                // @ts-ignore
                fetchHandler = browser$1;
            }
            else {
            ...
            let charset = isGbk ? 'gbk' : 'utf8';
            const fetchResult = yield fetchHandler(url, {
                method,
                headers,
                body,
                // @ts-ignore
            ...
            let json;
            if (charset === 'gbk') {
                let arrayBuffer = yield fetchResult.arrayBuffer();
                // 返回 buffer
                // const iconv = require('iconv-lite');
                // res = iconv.decode(res, charset);
                // @ts-ignore
                let string = gbk$1.decode(new Uint8Array(arrayBuffer));
                json = JSON.parse(string);
            }
            else {
                json = yield fetchResult.json();
            }
            // 返回 json
            if (json.ret === 0) {
                return json;
            ...
            return Promise.reject({
                ret: json.ret,
                msg: errorCode$1[json.ret] || json.msg || '',
                data: {},
            });
        });
    }

    class NLP extends AbstractTencentAI {
        /**
         * 自然语言处理基础部分
         *
         ...
         */
        seg(text) {
            return Request(this.proxy, URIS.wordseg, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                text: textToGBK(text),
            }), true);
        }
         ...
         */
        pos(text) {
            return Request(this.proxy, URIS.wordpos, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                text: textToGBK(text),
            }), true);
        }
         ...
         */
        ner(text) {
            return Request(this.proxy, URIS.wordner, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                text: textToGBK(text),
            }), true);
        }
         ...
         */
        syn(text) {
            return Request(this.proxy, URIS.wordsyn, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                text: textToGBK(text),
            }), true);
        }
         ...
         */
        com(text) {
            return Request(this.proxy, URIS.wordcom, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                text,
            }));
        }
         ...
         */
        textPolar(text) {
            return Request(this.proxy, URIS.textpolar, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                text,
            }));
        }
        ...
        textChat(question, session) {
            return Request(this.proxy, URIS.textchat, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                question,
                session,
            }));
    ...
    class Face extends AbstractTencentAI {
        /**
         * 面部识别 API 服务类
         *
        ...
        detect(image, mode = 1) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.detectface, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    mode,
                }));
        ...
        detectmulti(image) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.detectmultiface, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                }));
            });
        ...
        compare(image_a, image_b) {
            return __awaiter(this, void 0, void 0, function* () {
                image_a = yield this.readFileSync(image_a);
                image_b = yield this.readFileSync(image_b);
                return Request(this.proxy, URIS.facecompare, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image_a,
                    image_b,
                }));
         ...
         * @return {Promise} A Promise Object
         */
        detectcrossage(source_image, target_image) {
            return __awaiter(this, void 0, void 0, function* () {
                source_image = yield this.readFileSync(source_image);
                target_image = yield this.readFileSync(target_image);
                return Request(this.proxy, URIS.detectcrossageface, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    source_image,
                    target_image,
                }));
        ...
        shape(image, mode = 1) {
            return __awaiter(this, void 0, void 0, function* () {
                if ((mode && mode < 0) || mode > 1) {
                    return error$1('mode 不能为空且检测模式，0-正常，1-大脸模式');
                }
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.faceshape, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    mode,
                }));
    ...
    class Image extends AbstractTencentAI {
        /**
         * 图片识别公共 API 服务类
         *
        ...
        porn(image = '', image_url = '') {
            return __awaiter(this, void 0, void 0, function* () {
                if (!image && !image_url) {
                    return error$1('image and url all empty');
                }
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.porn, this.appKey, Object.assign({}, commonParams(), { app_id: this.appId }, image ? { image } : { image_url }));
            });
        }
        /**
         * 暴恐识别
        ...
        terrorism(image = '', image_url = '') {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.terrorism, this.appKey, Object.assign({}, commonParams(), { app_id: this.appId }, image_url ? { image_url } : { image }));
            });
        }
        /**
         * 场景识别
        ...
        scener(image, format = 1, topk = 1) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.scener, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    format,
                    topk,
        ...
        objectr(image, format = 1, topk = 1) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.objectr, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    format,
                    topk,
        ...
        tag(image) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.imagetag, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                }));
            });
         ...
         * @return {Promise} A Promise Object
         */
        identify(image, scene = 1) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.imgidentify, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    scene,
                }));
         ...
         * @return {Promise} A Promise Object
         */
        toText(image, session_id) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.imgtotext, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    session_id,
                }));
        ...
        fuzzy(image) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.imagefuzzy, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                }));
            });
        ...
        food(image) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.imagefood, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                }));
            });
    ...
    class ImageSpecialEffects extends AbstractTencentAI {
        /**
         * 图片特效API服务类
         *
        ...
        faceCosmetic(image, cosmetic = 1) {
            return __awaiter(this, void 0, void 0, function* () {
                if (cosmetic && cosmetic < 1 && cosmetic > 22) {
                    return error$1('cosmetic 不能为空且取值区间为[1-23]');
                }
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.facecosmetic, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    cosmetic,
                }));
        ...
        faceDecoration(image, decoration = 1) {
            return __awaiter(this, void 0, void 0, function* () {
                if (decoration && decoration < 1 && decoration > 22) {
                    return error$1('decoration 不能为空且取值区间为[1-22]');
                }
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.facedecoration, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    decoration,
                }));
         ...
         * @return {Promise} A Promise Object
         */
        ptuFilter(image, filter) {
            return __awaiter(this, void 0, void 0, function* () {
                if (filter && filter < 1 && filter > 32) {
                    return error$1('filter 不能为空且取值区间为[1-32]');
                }
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.ptuimgfilter, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    filter,
                }));
         ...
         * @return {Promise} A Promise Object
         */
        visionFilter(image, filter, session_id) {
            return __awaiter(this, void 0, void 0, function* () {
                if (filter && filter < 1 && filter > 65) {
                    return error$1('filter 不能为空且取值区间为[1-65]');
                }
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.visionimgfilter, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    filter,
                    session_id,
        ...
        faceMerge(image, model) {
            return __awaiter(this, void 0, void 0, function* () {
                if (model && model < 1 && model > 50) {
                    return error$1('model 不能为空且取值区间为[1-50]');
                }
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.facemerge, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    model,
                }));
        ...
        faceSticker(image, sticker) {
            return __awaiter(this, void 0, void 0, function* () {
                if (sticker && sticker < 1 && sticker > 32) {
                    return error$1('model 不能为空且取值区间为[1-31]');
                }
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.facesticker, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    sticker,
                }));
        ...
        faceAge(image) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.faceage, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                }));
            });
    ...
    class OCR extends AbstractTencentAI {
        /**
         * OCR 服务类
         *
         ...
         * @return {Promise} A Promise Object
         */
        idcard(image, card_type = 0) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.idcardocr, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    card_type,
                }));
        ...
        bc(image) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.bcocr, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                }));
            });
         ...
         * @return {Promise} A Promise Object
         */
        driverLicense(image, type = 1) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.driverlicenseocr, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    type,
                }));
        ...
        general(image) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.generalocr, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                }));
            });
        ...
        bizlicense(image) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.bizlicenseocr, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                }));
            });
        ...
        creditcard(image) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.creditcardocr, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                }));
            });
        ...
        plate(image) {
            return __awaiter(this, void 0, void 0, function* () {
                if (image && /^http\S*[.jpg|.bmp|.png]$/g.test(image)) {
                    return Request(this.proxy, URIS.plateocr, this.appKey, Object.assign({}, commonParams(), {
                        app_id: this.appId,
                        image_url: image,
                    }));
                }
        ...
        handwriting(image) {
            return __awaiter(this, void 0, void 0, function* () {
                if (image && /^http\S*[.jpg|.bmp|.png]$/g.test(image)) {
                    return Request(this.proxy, URIS.handwritingocr, this.appKey, Object.assign({}, commonParams(), {
                        app_id: this.appId,
                        image_url: image,
                    }));
                }
    ...
    class Person extends AbstractTencentAI {
        /**
         * 人体管理 API 服务类
         *
        ...
        newPerson(image, person_name, group_ids, person_id, tag) {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.newperson, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    person_name,
                    group_ids,
        ...
        deletePerson(person_id) {
            if (!person_id) {
                return error$1('person_id 不能为空');
            }
            return Request(this.proxy, URIS.delperson, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                person_id,
            }));
        }
        ...
        addFace(images, person_id, tag) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                images = yield this.readFileSync(images);
                return Request(this.proxy, URIS.addface, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    images,
                    person_id,
                    tag,
         ...
         * @return {Promise} A Promise Object
         */
        deleteFace(person_id, face_ids) {
            if (!person_id) {
                return error$1('person_id 不能为空');
            }
            if (!face_ids) {
                return error$1('face_ids 不能为空');
            }
            return Request(this.proxy, URIS.delface, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                person_id,
                face_ids,
            }));
        ...
        setinfo(person_id, person_name, tag) {
            ...
            if (!person_name) {
                return error$1('person_name 不能为空');
            }
            return Request(this.proxy, URIS.setinfo, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                person_id,
                person_name,
                tag,
        ...
        getinfo(person_id) {
            ...
            return Request(this.proxy, URIS.getinfo, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                person_id,
            }));
        }
         ...
         */
        getGroupIds() {
            return Request(this.proxy, URIS.getgroupids, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
            }));
        }
        /**
        ...
        getPersonIds(group_id) {
            if (!group_id) {
                return error$1('group_id 不能为空');
            }
            return Request(this.proxy, URIS.getpersonids, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                group_id,
            }));
        }
        ...
        getFaceIds(person_id) {
            ...
            return Request(this.proxy, URIS.getfaceids, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                person_id,
            }));
        }
        ...
        getFaceinfo(face_id) {
            if (!face_id) {
                return error$1('face_id 不能为空');
            }
            return Request(this.proxy, URIS.getfaceinfo, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                face_id,
            }));
        }
        ...
        faceIdentify(image, group_id, topn = 9) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if ((topn && topn < 1) || topn > 10) {
                    return error$1('topn 不能为空且取值范围为[1~10]');
                }
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.faceidentify, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    group_id,
                    topn,
        ...
        faceVerify(image, person_id) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.faceverify, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    person_id,
                }));
    ...
    class Speech extends AbstractTencentAI {
        /**
         * 智能语音 API 服务类
         *
        ...
        evilaudio(speech_id, speech_url) {
            return Request(this.proxy, URIS.evilaudio, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                speech_id,
                speech_url,
            }));
        ...
        tts(text, speaker = 1, format = 2, volume = 10, speed = 100, aht = 0, apc = 58) {
            return Request(this.proxy, URIS.tts, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                text,
                speaker,
                format,
        ...
        tta(text, model_type = 0, speed = 0) {
            if (typeof Buffer !== 'undefined') {
                if (text && Buffer.byteLength(text, 'utf8') > 300) {
                    return error$1('text不能为空 或者应小于 300B');
                }
            }
            return Request(this.proxy, URIS.tta, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                text,
                model_type,
                speed,
        ...
        asr(speech, format = 2, rate = 8000) {
            return __awaiter(this, void 0, void 0, function* () {
                speech = yield this.readFileSync(speech);
                return Request(this.proxy, URIS.asr, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    speech,
                    format,
                    rate,
        ...
        asrs(speech_chunk, speech_id, len = 0, seq = 0, end = 1, format = 2, rate = 8000) {
            return __awaiter(this, void 0, void 0, function* () {
                speech_chunk = yield this.readFileSync(speech_chunk);
                return Request(this.proxy, URIS.asrs, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    speech_chunk,
                    speech_id,
                    len,
        ...
        wxasrs(speech_chunk, speech_id, len = 0, seq = 0, end = 1, format = 2, rate = 16000, bits = 16, cont_res = 0) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (speech_chunk && speech_id && len) {
                    return Request(this.proxy, URIS.wxasrs, this.appKey, Object.assign({}, commonParams(), {
                        app_id: this.appId,
                        speech_chunk,
                        speech_id,
                        len,
                    ...
                    return error$1('speech_chunk/speech_id 不能为空, len不能为0');
                }
            });
        }
        /**
        ...
        wxasrlong(format = 2, callback_url, speech = '', speech_url = '') {
            return __awaiter(this, void 0, void 0, function* () {
                speech = yield this.readFileSync(speech);
                return Request(this.proxy, URIS.wxasrlong, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    speech_url,
                    speech,
                    callback_url,
         ...
         * @return {Promise}
         */
        detectkeyword(callback_url, key_words, format = 2, speech = '', speech_url = '') {
            return __awaiter(this, void 0, void 0, function* () {
                speech = yield this.readFileSync(speech);
                return Request(this.proxy, URIS.detectkeyword, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    callback_url,
                    key_words,
                    format,
    ...
    class Translate extends AbstractTencentAI {
        /**
         * 机器翻译API构造函数
         *
         ...
         * @return {Promise} A Promise Object
         */
        textByAILab(text, type = 0) {
            return Request(this.proxy, URIS.texttrans, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                type,
                text,
            }));
         ...
         * @return {Promise} A Promise Object
         */
        text(text, source = 'auto', target = 'zh') {
            return Request(this.proxy, URIS.texttranslate, this.appKey, Object.assign({}, commonParams(), {
                app_id: this.appId,
                text,
                source,
                target,
         ...
         * @return {Promise} A Promise Object
         */
        image(image, session_id, scene = 'word', source = 'auto', target = 'en') {
            return __awaiter(this, void 0, void 0, function* () {
                image = yield this.readFileSync(image);
                return Request(this.proxy, URIS.imagetranslate, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    image,
                    session_id,
                    scene,
         ...
         * @return {Promise} A Promise Object
         */
        speech(speech_chunk, session_id, format = 8, seq = 0, end = 1, source = 'auto', target = 'auto') {
            return __awaiter(this, void 0, void 0, function* () {
                speech_chunk = yield this.readFileSync(speech_chunk);
                return Request(this.proxy, URIS.speechtranslate, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    format,
                    seq,
                    end,
            ...
            return __awaiter(this, void 0, void 0, function* () {
                if (typeof Buffer !== 'undefined') {
                    if (!text || Buffer.byteLength(text, 'utf8') > 1024) {
                        return error$1('text不能为空 或者应小于 1024B');
                    }
                }
                return Request(this.proxy, URIS.textdetect, this.appKey, Object.assign({}, commonParams(), {
                    app_id: this.appId,
                    text,
                    candidate_langs,
                    force,
    ...
    exports.Face = Face;
    exports.Image = Image;
    exports.ImageSpecialEffects = ImageSpecialEffects;
    exports.NLP = NLP;
    exports.OCR = OCR;
    exports.Person = Person;
    exports.Speech = Speech;
    exports.TencentAI = TencentAI;
    exports.TencentAIError = TencentAIError;
    exports.Translate = Translate;
    exports.default = TencentAI;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
