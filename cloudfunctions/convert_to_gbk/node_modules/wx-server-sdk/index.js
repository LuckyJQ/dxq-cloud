...
var Cloud = /** @class */ (function () {
    function Cloud() {
        ...
        this.exportAPI = {
            ...
            // @ts-ignore
            createNewInstance: function (config) {
    ...
    Cloud.prototype.updateConfig = function (config) {
        if (config === void 0) { config = {}; }
        this.provider.init(tslib_1.__assign({}, config, { version: "wx-server-sdk/1.4.0" }));
...
exports.getInstance = function (config) {
    ...
    if (process.env.TENCENTCLOUD_RUNENV === 'WX_LOCAL_SCF') {
        // @ts-ignore
        var instance = tcb.init(tslib_1.__assign({}, tcb.config, config, { env: utils_1.translateEnv(config.env || tcb.config.envName), isHttp: true }));
        ...
        // @ts-ignore
        var instance = tcb.init(tslib_1.__assign({}, tcb.config, config, { env: utils_1.translateEnv(config.env || tcb.config.envName) }));
        instance.config.secretId = undefined;
        instance.config.secretKey = undefined;
        instance.config.sessionToken = undefined;
        return instance;
...
var getDatabaseClass = function (cloud) {
    return /** @class */ (function () {
        function Database(config) {
            ...
            var apiEnv = utils_1.isSCFEnvReady() ? utils_1.getEnvFromAPIConfig(config, cloud.config, __1.DATABASE_SERVICE_NAME) :
                (cloud.config.env && (cloud.config.env.database || cloud.config.env.default));
            // @ts-ignore
...
exports.isSCFEnvReady = function () { return Boolean(process.env.TCB_ENV); };
exports.translateEnv = function (env) {
    if (!env) {
        return undefined;
    }
    if (env === symbol_config_1.SYMBOL_DYNAMIC_CURRENT_ENV) {
...
exports.getEnvFromCloudConfig = function (config, serviceName) {
    if (serviceName === void 0) { serviceName = 'default'; }
    var env = config.env[serviceName] || config.env.default;
    return exports.translateEnv(env);
};
exports.getEnvFromAPIConfig = function (apiConfig, cloudConfig, serviceName) {
    if (serviceName === void 0) { serviceName = 'default'; }
